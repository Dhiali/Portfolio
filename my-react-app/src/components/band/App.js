...
const GLTF_PATH = process.env.PUBLIC_URL + '/assets/kartu.glb';
const TEXTURE_PATH = process.env.PUBLIC_URL + '/assets/bandd.png';
...
export default function BandApp() {
  return (
    <div className="responsive-wrapper" style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', minHeight: '100vh' }}>
